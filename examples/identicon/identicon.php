...
class identicon {
	...
	function identicon_build($seed='',$altImgText='',$img=true,$outsize='',$write=true,$random=true,$displaysize=''){
        ...
        if (function_exists("gd_info")){
			...
			$filename=substr(sha1($seed),0,15).'.png';
...
function identicon_get_options(){
    $default_array=array('size'=>64,'backr'=>array(255,255),'backg'=>array(255,255),'backb'=>array(255,255), 'forer'=>array(1,255),'foreg'=>array(1,255),'foreb'=>array(1,255),'squares'=>4,'grey'=>0);
...
function identicon_build($seed='',$altImgText='',$img=true,$outsize='',$write=true,$random=true,$displaysize=''){
	global $identicon;
	return $identicon->identicon_build($seed,$altImgText,$img,$outsize,$write,$random,$displaysize);
}
?>
