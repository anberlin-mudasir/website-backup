...
{
?>
      <div class="feedTip min-succeed"><p>删除成功!请返回<a href="javascript:document.back.submit()">管理员面板</a></p></div>
<?php
}
else
{
?>
      <div class="feedTip min-fail"><p>操作失败!请返回<a href="javascript:document.back.submit()">管理员面板</a></p></div>
<?php
}
?>
    </div>
